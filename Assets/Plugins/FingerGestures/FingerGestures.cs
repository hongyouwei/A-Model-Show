...
public abstract class FingerGestures : MonoBehaviour
{
    ...
    public delegate void FingerDownEventHandler(Finger finger );
    ...
    internal static void RaiseOnFingerDown(Finger source )
    {
    ...
    void InitDefaultComponents()
    {
        ...
        if( fingerComponentNodes != null )
        {
            ...
            {
                var fingerCompNode = fingerComponentNodes[i];
    ...
    public class FingerList : IFingerList
    {
        ...
        static FingerPropertyGetterDelegate<Vector2> FingerPosDelegate = new FingerPropertyGetterDelegate<Vector2>(GetFingerPosition);
        public Vector2 GetAveragePosition()
        {
            //return AverageVector(GetFingerPosition);
            return AverageVector(FingerPosDelegate);
        }
